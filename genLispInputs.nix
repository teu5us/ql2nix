...
let
  local-systems-with-project = local-systems // lib.attrsets.optionalAttrs
  ...
  local-system-paths-raw = lib.attrsets.attrValues local-systems-with-project;
in
...
let
  ...
  local-system-names = lib.attrsets.attrNames local-systems-with-project;
